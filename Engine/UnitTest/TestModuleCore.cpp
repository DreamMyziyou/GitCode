...
class TestModule01 final : public ModuleCore::IModule
{
...
class TestModule02 final : public ModuleCore::IModule
{
...
class TestModule03 final : public ModuleCore::IModule
{
...
class TestModule04 final : public ModuleCore::IModule
{
